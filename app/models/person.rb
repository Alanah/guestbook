class Person < ActiveRecord::Base
  ...
  #Â restrict birthday to reasonable values, ie. not in the future and not
  # before 1900
  ...
  #Â only allows you to post valid times, remember that models can be created
  ...
  #Â if person says 'can send email', then we'd like them to fill their
